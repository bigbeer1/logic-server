...
var (
	...
	messagesFeedbacks   = "/messages/{message_id}/feedbacks"
	messages            = "/messages"
	conversations       = "/conversations"
	conversationsRename = "/conversations/{conversation_id}/name"
...
type VideoMessageStreamResponse struct {
	Event          string `json:"event"`
	TaskID         string `json:"task_id"`
	ID             string `json:"id"`
	Answer         string `json:"answer"`
...
type VideoMessageStreamChannelResponse struct {
